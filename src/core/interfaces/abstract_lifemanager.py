...
Ejemplo de uso::
    ...
    cita_id = mgr.create_appointment(date.today(), "10:00", "Médico")
"""
...
class AbstractLifeManager(ABC):
    ...
    def create_appointment(self, date: date, time: str, type: str, notes: str = "") -> UUID:
        ...
        Args:
            ...
            type (str): Tipo o título de la cita. Ej: ``"Médico"``, ``"Reunión"``.
        ...
        Raises:
            ...
            ValueError: Si ``type`` está vacío.

        Example::

            cita_id = mgr.create_appointment(
                date(2026, 3, 24), "10:00", "Médico", "llevar analítica"
            )
        """
        pass
